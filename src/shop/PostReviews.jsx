...
const PostReviews = ({ isModalOpen, handleCloseReviewModal }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert(
        error?.data?.message || "An error occurred while posting your comment"
      );
    }
    ...
    <div className={`${isModalOpen ? "postreview-modal" : "close"}`}>
      <div className="postreview-wrapper">
        ...
        <div className="postreview-btns">
          <button onClick={handleCloseReviewModal} disabled={isLoading}>
            Cancel
          </button>
